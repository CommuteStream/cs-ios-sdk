...
@interface CSMRAIDModalViewController ()
{
...
@implementation CSMRAIDModalViewController
...
- (id)initWithOrientationProperties:(CSMRAIDOrientationProperties *)orientationProps
{
    self = [super init];
    if (self) {
...
-(void)viewWillAppear:(BOOL)animated
{
    ...
    [CSLogger debug:@"MRAID - ModalViewController" withMessage:[NSString stringWithFormat:@"%@ %@", [self.class description], NSStringFromSelector(_cmd)]];
...
- (BOOL)shouldAutorotate
{
    ...
    [CSLogger debug:@"MRAID - ModalViewController" withMessage:[NSString stringWithFormat: @"%@ %@ %@", [self.class description], NSStringFromSelector(_cmd), (retval ? @"YES" : @"NO")]];
    return retval;
}

- (UIInterfaceOrientation)preferredInterfaceOrientationForPresentation
{
    [CSLogger debug:@"MRAID - ModalViewController" withMessage:[NSString stringWithFormat: @"%@ %@ %@",
...
- (void)didRotateFromInterfaceOrientation:(UIInterfaceOrientation)fromInterfaceOrientation
{
    ...
    [CSLogger debug:@"MRAID - ModalViewController" withMessage:[NSString stringWithFormat:@"%@ %@from %@ to %@",
                                                                [self.class description],
                                                                NSStringFromSelector(_cmd),
...
- (void)forceToOrientation:(CSMRAIDOrientationProperties *)orientationProps;
{
    ...
    [CSLogger debug:@"MRAID - ModalViewController" withMessage:[NSString stringWithFormat:@"requesting from %@ to %@",
