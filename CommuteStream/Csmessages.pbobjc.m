...
@implementation CSPCsmessagesRoot
...
#pragma mark - CSPCsmessagesRoot_FileDescriptor

static GPBFileDescriptor *CSPCsmessagesRoot_FileDescriptor(void) {
  ...
  if (!descriptor) {
    ...
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:[CSPStop class]
                                     rootClass:[CSPCsmessagesRoot class]
                                          file:CSPCsmessagesRoot_FileDescriptor()
                                        fields:fields
